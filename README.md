Added login + follow mutation (it takes some time to process + you may need to update the page) + query for text publications (images etc don't work well for now) of the profile.
